...
public class Options extends JPanel{
	...
	private void configure(){
		jtbOptions = new JToolBar("Toolbar Personen"); 
		
		jbAdd = createButton("Hinzfuegen", "add_obj");
		jbEdit = createButton("Edit", "edit");
		jbDetails = createButton("Edit", "details");
		jbRemove = createButton("Entfernen", "remove");
